...
import { 
  setupEventHandlers, moveDirection, isTouchscreenDevice, touchEvent, createJoystick 
} from './resources/eventHandlers';
import { 
  preloadDivs, preloadOpacity, postloadDivs, startScreenDivs, startButton, noWebGL, fadeOutDivs 
} from './resources/preload';
import { 
  clock, scene, camera, renderer, stats, manager, createWorld, lensFlareObject, createLensFlare, 
  particleGroup, particleAttributes, particleSystemObject, glowingParticles, addParticles, 
  moveParticles, generateGalaxy, galaxyMaterial, galaxyClock, galaxyPoints 
} from './resources/world';
import { 
  simpleText, floatingLabel, allSkillsSection, createTextOnPlane 
} from './resources/surfaces';
import { 
  pickPosition, launchClickPosition, getCanvasRelativePosition, rotateCamera, launchHover 
} from './resources/utils';

export let cursorHoverObjects = [];

// Textures (Previously from textures.js)

// Billboard textures
let billboardTextures = {
  terpSolutionsTexture: '3D-WEB-PortFolio/src/jsm/zootopic.gif',
  bagHolderBetsTexture: '3D-WEB-PortFolio/src/jsm/Bagholdersbetsbillboard.png',
  homeSweetHomeTexture: '3D-WEB-PortFolio/src/jsm/home-sweet-home-portrait.png'
};

// Box textures
let boxTexture = {
  Github: '3D-WEB-PortFolio/src/jsm/githubLogo.png',
  twitter: '3D-WEB-PortFolio/src/jsm/twitter.png',
  LinkedIn: '3D-WEB-PortFolio/src/jsm/linkedInLogo.png',
  mail: '3D-WEB-PortFolio/src/jsm/envelope.png',
  globe: '3D-WEB-PortFolio/src/jsm/thunder.png',
  reactIcon: '3D-WEB-PortFolio/src/jsm/react.png',
  allSkills: '3D-WEB-PortFolio/src/jsm/allSkills.png',
  lensFlareMain: '3D-WEB-PortFolio/src/jsm/lensflare0.png',
  skrillex: '3D-WEB-PortFolio/src/jsm/skrillex.png',
  edmText: '3D-WEB-PortFolio/src/jsm/EDM.png'
};

// Material textures
let stoneTexture = '3D-WEB-PortFolio/src/jsm/stone.png';
let woodTexture = '3D-WEB-PortFolio/src/jsm/woodTexture.jpg';

// Text content
let inputText = {
  terpSolutionsText: '3D-WEB-PortFolio/src/jsm/terp-solutions-text.png',
  activities: '3D-WEB-PortFolio/src/jsm/activities_text.png',
  certification: '3D-WEB-PortFolio/src/jsm/certification.png',
  redhat: '3D-WEB-PortFolio/src/jsm/redhat.png',
  bagholderBetsText: '3D-WEB-PortFolio/src/jsm/bagholderbets-text.png',
  homeSweetHomeText: '3D-WEB-PortFolio/src/jsm/text.png',
  staticPortfolio: '3D-WEB-PortFolio/src/jsm/static-portfolio.png'
};
...
Ammo().then((Ammo) => {
  ...
  function loadFloydText() {
    ...
    text_loader.load('./src/jsm/Roboto_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('KYS', {
        font: font,
        size: 3,
        height: 0.5,
        curveSegments: 12,
  ...
  function loadEngineerText() {
    ...
    text_loader.load('./src/jsm/Roboto_Regular.json', function (font) {
      ...
      var geometry = new THREE.TextGeometry('INFRA ENGINEER', {
        font: font,
        size: 1.5,
        height: 0.5,
        curveSegments: 20,
...
//아래 트위터 - 밸로그로바꿨던거같음/
    ...
    // 링크드인임
    createBox(27, 2, -70, 4, 4, 1, boxTexture.mail, URL.LinkedIn , 0x000000, true);
    ...
    floatingLabel(19.125, 4.5, -70, 'Velog');
    ...
    allSkillsSection(61, 0.025, -2, 30, 60, inputText.activities);
    allSkillsSection(61, 0.025, 55, 30, 60, inputText.redhat);
    allSkillsSection(61, 0.025, -2, 30, 60, inputText.activities);
    allSkillsSection(-45, 0.025, 0, 30, 35, inputText.certification);
    ...
    simpleText(61, 0.01, -32, 'TIMELINE', 3);
    simpleText(61, 0.01, 25, 'Education', 3);
    simpleText(-43, 0.01, -20, 'CERTIFICATION', 2.5);
