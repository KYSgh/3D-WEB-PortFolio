...
let billboardTextures = {
  terpSolutionsTexture: 'src/jsm/zootopic.gif',
  bagHolderBetsTexture: 'src/jsm/Bagholdersbetsbillboard.png',
  homeSweetHomeTexture: 'src/jsm/home-sweet-home-portrait.png'
};

// Box textures
let boxTexture = {
  Github: 'src/jsm/githubLogo.png',
  twitter: 'src/jsm/twitter.png',
  LinkedIn: 'src/jsm/linkedInLogo.png',
  mail: 'src/jsm/envelope.png',
  globe: 'src/jsm/thunder.png',
  reactIcon: 'src/jsm/react.png',
  allSkills: 'src/jsm/allSkills.png',
  lensFlareMain: 'src/jsm/lensflare0.png',
  skrillex: 'src/jsm/skrillex.png',
  edmText: 'src/jsm/EDM.png'
};
...
let inputText = {
  ...
  activities: 'src/jsm/activities_text.png',
  certification: 'src/jsm/certification.png',
  redhat: 'src/jsm/redhat.png',
  bagholderBetsText: 'src/jsm/bagholderbets-text.png',
  homeSweetHomeText: 'src/jsm/text.png',
  staticPortfolio: 'src/jsm/static-portfolio.png'
};
